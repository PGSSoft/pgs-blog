...
import com.pgs.spark.bigdata.algorithmComparator.config.codec.ClassificationCodec;
import com.pgs.spark.bigdata.algorithmComparator.config.codec.CustomZonedDateTimeCodec;
...
public class CassandraConfig {
    ...
    @Value("${cassandraMigrationLocations}")
    private String[] cassandraMigrationsLocation;
