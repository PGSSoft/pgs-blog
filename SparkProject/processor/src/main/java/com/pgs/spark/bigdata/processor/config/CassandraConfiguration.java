...
import com.pgs.spark.bigdata.processor.config.codec.ClassificationCodec;
import com.pgs.spark.bigdata.processor.config.codec.CustomZonedDateTimeCodec;
...
public class CassandraConfiguration {
    ...
    /**
     * Helper method to instantiate given type.
     *
